package com.wilddev.betterchatcolours.utils;
...
public class MiniMessageUtils {
    ...
    private static final Pattern FORMATTING_PATTERN = Pattern.compile("(&[k-or])|(<(bold|italic|underlined|strikethrough|obfuscated|b|i|u|st|o)>)");
